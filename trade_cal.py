...
def get_nearby_trade_date(date: str, trade_cal) -> str:
    """
...
def get_latest_trade_date(trade_cal) -> date:
    today = date.today()
    today_str = str(today)

    for idx, trade_date in enumerate(trade_cal):
        if trade_date == today_str:
            return today
        elif trade_date < today_str:
            return date_parser.parse(trade_cal[idx]).date()
...
if str(date.today()) > cn_trade_cal[0]:
